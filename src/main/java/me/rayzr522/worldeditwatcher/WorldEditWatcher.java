 ...
 * @author Rayzr
 */
public class WorldEditWatcher extends JavaPlugin {
    private static WorldEditWatcher instance;
    private MessageHandler messages = new MessageHandler();

    /**
     * @return The current instance of WorldEditWatcher.
     */
    public static WorldEditWatcher getInstance() {
        return instance;
    }
